...
@section('title', 'Мониторинг пользователей')

@section('content')
    <div class="max-w-6xl mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">Мониторинг пользователей</h1>
                ...
                <tbody>
                    @foreach ($users as $user)
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="{{ route('auth.users.toggle', $user) }}">
                                    @csrf
