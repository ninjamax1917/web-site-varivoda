...
<section class="w-full py-12 md:py-16">
    <div class="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8">
        <h2 class="text-2xl md:text-3xl font-bold tracking-tight mb-2 text-gray-900 dark:text-gray-100">Наши компетенции
        </h2>
        <h3
            class="text-base sm:text-lg md:text-xl font-normal leading-relaxed text-gray-700/90 dark:text-gray-300 mb-6 max-w-3xl">
            Ознакомьтесь с нашими лицензиями и сертификатами, которые гарантируют высокий уровень наших услуг и
            квалификацию сотрудников
        </h3>

        <div
            class="rounded-2xl bg-gradient-to-b from-[#F8FBFF] to-white dark:from-[#1A1A1D] dark:to-[#141416] ring-1 ring-gray-200/70 dark:ring-white/10 p-3 sm:p-4">
                ...
                <div class="swiper-wrapper items-stretch">
                    @foreach ($certificates ?? [] as $key => $it)
                        @php
                            ...
                            $link = '#';
                            if ($hasPdf) {
                                $link = URLFacade::temporarySignedRoute('certificates.show', now()->addMinutes(15), [
                                    'key' => $key,
                                ]);
                            } elseif ($isMchsWeb) {
                        ...
                        <div class="swiper-slide">
                            <a href="{{ $link }}" target="_blank" rel="noopener" class="block group h-full">
                                <div
                                    class="card bg-gray-200/70 dark:bg-[#232325]/50 w-full h-[500px] sm:h-[520px] md:h-[560px] lg:h-[560px] shadow-lg overflow-hidden flex flex-col transition-transform duration-200 group-hover:-translate-y-1 group-hover:shadow-xl">
                                    <div
